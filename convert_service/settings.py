#
# @setting.py Copyright (c) 2021 Jalasoft.
...
ALLOWED_HOSTS = ['192.168.33.60', 'localhost', '127.0.0.1']
...
ROOT_URLCONF = 'convert_service.urls'
...
WSGI_APPLICATION = 'convert_service.wsgi.application'
